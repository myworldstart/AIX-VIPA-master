...
from asm.net.semantic_sam.utils.arguments import load_opt_from_config_file
from asm.net.semantic_sam.BaseModel import BaseModel
from asm.net.semantic_sam import build_model
from asm.net.semantic_sam.tasks.interactive_idino_m2m_auto import show_anns
...
def prepare_image(image_pth):
    ...
    # t.append(transforms.Resize(640, interpolation=InterpolationMode.BICUBIC))
